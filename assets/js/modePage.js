function darkmode()
{
    ...
    var h1Elements = document.getElementsByClassName("home__title-color");

    for(var i = 0; i < h1Elements.length; i++) {
    h1Elements[i].style.color = "#3e6ff4";
    }
}
...
function lightmode()
{
    ...
    var darkbutton = document.getElementsByClassName("white");

    for(var i = 0; i < darkbutton.length; i++) {
        darkbutton[i].style.backgroundColor = "white";
    }
    ...
    var h1Elements = document.getElementsByClassName("footer__title");
